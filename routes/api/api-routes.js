...
module.exports = function (app) {
  ...
  app.put("/api/updataskstatus", function (req, res) {
    var data = req.body;
    console.log(data);
    db.Task.update({ status: "Assigned" }, { where: { id: data.id } })
      .then(function () {
  ...
  app.get("/api/viewclienttasks", function (req, res) {
    db.sequelize
      .query(
        " select `ClientTasks`.`id` as `clienttasks_id`, `ClientTasks`.`status` as `clienttasks_status`, " +
  ...
  app.get("/api/viewclienttasksclient/:clientId", function (req, res) {
  ...
  app.put("/api/updateassignedtaskstatus", function (req, res) {
    var data = req.body;
    console.log(data);
    db.ClientTask.update({ status: "Completed" }, { where: { id: data.id } })
      .then(function () {
